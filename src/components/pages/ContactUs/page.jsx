  ...
  return (
    <>
      <div className="w-3/4 m-auto">
        ...
        <h2 className="text-slate-500 text-[20px] mb-10">
        ...
        <div className="flex my-28 gap-20">
          <div>
            <ContactForm />
          </div>
          <div>
            <h2 className="mb-10 text-slate-900 font-semibold text-[50px]">
              Store Locations
            </h2>
            <div className="text-slate-500 grid grid-cols-2 gap-20 text-[20px]">
              <div>
                <span>(626) 205-2601</span>
                <div>340 Meadow Ln Monrovia, California(CA), 91016</div>
              </div>
              <div>
                <span>(540) 206-3379</span>
                <div>1321 Rorer Ave SW Roanoke, Virginia(VA), 24016</div>
              </div>
              <div>
                <span>(978) 774-9720</span>
