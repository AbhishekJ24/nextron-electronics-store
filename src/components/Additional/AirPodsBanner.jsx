    ...
    return (
        <div className="bg-slate-200 sm:relative h-[26rem] sm:h-[28rem] md:h-[30rem] lg:h-[35rem] xl:h-[40rem]">
            ...
            <div className="pt-1 sm:hidden text-center">
                ...
                <button className='inter block m-auto mt-2 py-2 px-8 rounded-xl text-base bg-slate-800 hover:bg-slate-700 transition-all hover:ease-in text-slate-50 font-semibold'>Buy $249</button>
            </div>
            <div className="hidden sm:block ml-36 pt-36">
                ...
                <button className="inter block rounded-xl bg-slate-800 hover:bg-slate-700 transition-all hover:ease-in text-slate-50 px-8 py-2 text-lg font-semibold drop-shadow-2xl">
                    Buy $249
                </button>
            </div>
            <img
